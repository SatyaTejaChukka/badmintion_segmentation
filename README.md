...
| --- | --- | --- | --- | --- | --- |
| `court_model.pth` | U-Net with a ResNet-18 encoder used to segment the badminton court area from each frame. | `99.48%` | `14.33M` | `54.76` | `76.64` |
...
The displayed test output in [`test_seg_model.py`](c:/Users/satya/Desktop/badminton_seg/test_seg_model.py) is optimized for smoother viewing:
